...
[grid/types.ts:24](https://github.com/flauwekeul/honeycomb/blob/3be8e81/src/grid/types.ts#L24)
...
[grid/types.ts:23](https://github.com/flauwekeul/honeycomb/blob/3be8e81/src/grid/types.ts#L23)
