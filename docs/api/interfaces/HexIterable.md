...
[grid/types.ts:58](https://github.com/flauwekeul/honeycomb/blob/master/src/grid/types.ts#L58)
...
[grid/types.ts:59](https://github.com/flauwekeul/honeycomb/blob/master/src/grid/types.ts#L59)
