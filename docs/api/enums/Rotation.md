...
[grid/types.ts:15](https://github.com/flauwekeul/honeycomb/blob/d2d905f/src/grid/types.ts#L15)
...
[grid/types.ts:16](https://github.com/flauwekeul/honeycomb/blob/d2d905f/src/grid/types.ts#L16)
