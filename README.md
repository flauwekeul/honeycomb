...
The beta of the next major version (v4) is [released](https://github.com/flauwekeul/honeycomb/releases) (see the [`beta`](https://github.com/flauwekeul/honeycomb/tree/beta) branch). It's a complete rewrite in TypeScript with all new shiny "traversers" 😎.

I could really use your feedback about this new version, so please take a look at the [readme](https://github.com/flauwekeul/honeycomb/tree/beta#honeycomb) in the [`beta`](https://github.com/flauwekeul/honeycomb/tree/beta) branch to see how you can start using it. Please open an [issue](https://github.com/flauwekeul/honeycomb/issues) and tell me what you like and/or don't like. Thanks! ✨
...
- [Honeycomb](#honeycomb)
  - [Next major version](#next-major-version)
    - [Features](#features)
  - [Installation](#installation)
  - [Getting started](#getting-started)
    - [Browser](#browser)
    - [Node.js](#nodejs)
    - [With ES2015 modules](#with-es2015-modules)
  - [Examples](#examples)
    - [Basic usage](#basic-usage)
    - [Rendering](#rendering)
      - [With PixiJS](#with-pixijs)
      - [With SVG.js](#with-svgjs)
    - [Grids extend `Array.prototype`](#grids-extend-arrayprototype)
      - [Grid methods that mutate](#grid-methods-thatmutate)
      - [Be careful with bracket notation](#be-careful-with-bracket-notation)
    - [Point → Hex](#point--hex)
    - [Grid shapes](#grid-shapes)
    - [Coordinate systems](#coordinate-systems)
    - [Odd or even hex offsets](#odd-or-even-hex-offsets)
