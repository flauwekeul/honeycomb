 ...
 * @category Coordinates
 */
export declare type PartialCubeCoordinates = {
    q?: number;
    r: number;
    s: number;
} | {
 ...
 * @category Hex
 */
export declare type HexOffset = 1 | -1;
/**
 * @category Hex
 */
 ...
 * @category Hex
 */
export declare type HexConstructor<T extends Hex> = new (coordinates?: HexCoordinates) => T;
