export declare type Infer<T extends Schema> = T extends Optional<infer U> ? Infer<U> : T extends Guard<infer U> ? U : T extends typeof String ? string : T extends typeof Number ? number : T extends typeof Boolean ? boolean : T extends readonly string[] ? T[number] : T extends readonly [typeof Array, Schema] ? Array<Infer<T[1]>> : {
...
export declare type Optional<T extends Schema> = Record<typeof opt, T>;
export declare type Guard<T> = (x: unknown) => x is T;
declare type OptionalKeys<T> = keyof {
...
export declare type Schema = typeof String | typeof Number | typeof Boolean | readonly string[] | readonly [typeof Array, Schema] | {
